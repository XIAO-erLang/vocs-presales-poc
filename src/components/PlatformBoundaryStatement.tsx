export function PlatformBoundaryStatement({ compact = false }: { compact?: boolean }) {
  return (
    <section className="flex gap-4 rounded-[28px] bg-field p-5 text-sm leading-7 text-muted ring-1 ring-black/[0.04] sm:p-6">
      <span className="mt-1 grid h-8 w-8 shrink-0 place-items-center rounded-full bg-white text-xs font-black text-leaf shadow-[0_8px_20px_rgba(46,46,46,0.06)]">
        i
      </span>
      <div>
        <p className="mb-2 font-black text-leaf-dark">平台边界说明</p>
