    ...
    <>
      ...
      <main className="container-page py-16 sm:py-20">
        <section className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-bold uppercase tracking-[0.1em] text-logo-green">Knowledge</p>
          <h1 className="mt-5 text-5xl font-extrabold leading-tight sm:text-7xl">工程经验、方法论与标准</h1>
          <p className="mt-6 text-base leading-7 text-muted sm:text-lg">
            Knowledge 是 Project 的知识沉淀层，让每一次判断、复核和交付都能转化成可复用资产。
          </p>
        </section>
